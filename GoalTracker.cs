    ...
    public void RecordEventInTracker()
{
    ...
    if (int.TryParse(goalIndex, out int goalIndexInt) && goalIndexInt >= 1 && goalIndexInt <= _goals.Count)
    {
        goalIndexInt--; // Decrement by 1 to match the zero-based index in the list
    ...
    {
        Console.WriteLine("Invalid goal index. Please enter a valid number.");
    }
}
